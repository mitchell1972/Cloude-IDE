...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/*", "video/*", "audio/*", "application/pdf", "application/zip"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for ide-assets" ON storage.objects FOR SELECT USING (bucket_id = 'ide-assets');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for ide-assets" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'ide-assets');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for ide-assets" ON storage.objects FOR UPDATE USING (bucket_id = 'ide-assets');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for ide-assets" ON storage.objects FOR DELETE USING (bucket_id = 'ide-assets');`
    ];
