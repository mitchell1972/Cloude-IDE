...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["text/plain", "text/javascript", "text/typescript", "text/html", "text/css", "application/json", "text/python", "text/x-java-source", "text/x-c++src", "text/xml", "text/yaml", "text/markdown"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for sdet-projects" ON storage.objects FOR SELECT USING (bucket_id = 'sdet-projects');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for sdet-projects" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'sdet-projects');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for sdet-projects" ON storage.objects FOR UPDATE USING (bucket_id = 'sdet-projects');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for sdet-projects" ON storage.objects FOR DELETE USING (bucket_id = 'sdet-projects');`
    ];
    ...
    return new Response(JSON.stringify({
        ...
        name: 'sdet-projects',
        public: true,
        allowed_mime_types: ["text/plain", "text/javascript", "text/typescript", "text/html", "text/css", "application/json", "text/python", "text/x-java-source", "text/x-c++src", "text/xml", "text/yaml", "text/markdown"],
